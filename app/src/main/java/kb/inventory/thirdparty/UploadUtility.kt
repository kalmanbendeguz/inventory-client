package kb.inventory.thirdparty
...
class UploadUtility(activity: Activity, _serverURL: String, _fileToUpload: File ) {
    ...
    var fileToUpload = _fileToUpload

    fun uploadFile(sourceFilePath: String, uploadedFileName: String? = null) {
        uploadFile(File(sourceFilePath), uploadedFileName)
    }

    fun uploadFile(uploadedFileName: String? = null) {
        val pathFromUri = fileToUpload.toURI()
